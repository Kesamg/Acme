...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="/acme/images/favicon.ico">
  ...
  <body style="background-image: url('/acme/images/nfl-main.png');background-size: 217px;background-color: #ecf2f7 !important;">
    <div class="container py-3" style="background: #fff;">
      <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
          <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
            <img src="/acme/images/logo.png" alt="ACME Sports Logo" width="186" height="112"/>
          </a>
      ...
      <footer class="pt-4 my-md-5 pt-md-5 border-top">
        <div class="row">
          <div class="col-12 col-md">
            <img class="mb-2" src="/acme/images/footer-logo.png" alt="ACME Sports Footer Icon" width="48" height="48">
